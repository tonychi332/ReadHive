...
export default async function AdminDashboardPage() {
  ...
  const [pendingBooks, users, settings, revenueAgg, liveBookCount] = await Promise.all([
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-10 px-4 py-12">
      <div>
        ...
        <p className="text-muted-foreground">Manage books, users, and platform settings</p>
      </div>
